...
const registerBillboardFace = async () => {
  ...
  if (isValid) 
  {
    ...
    formData.append('zone_id', zone.value.id)
    formData.append('billboard_structure_id', billboard_structure.value.id)
    formData.append('advertiser_id', advertiser.value.id)
  ...
  else
  {
    ...
    console.log('Errores:', JSON.parse(JSON.stringify(errors.value)));
  }
}
</script>
...
<template>
  <div>
    ...
    <VRow class="justify-center">
      <VCol md="8">
        <VCard title="Informaci&oacute;n de la valla">
          <VCardText>
            <VRow>
