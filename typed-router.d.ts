...
declare module 'vue-router/auto/routes' {
  export interface RouteNamedMap {
    ...
    'opportunities-my-contacts': RouteRecordInfo<'opportunities-my-contacts', '/opportunities/myContacts', Record<never, never>, Record<never, never>>,
    ...
    'perfil-myperfil': RouteRecordInfo<'perfil-myperfil', '/perfil/myperfil', Record<never, never>, Record<never, never>>,
    'quote-id': RouteRecordInfo<'quote-id', '/quote/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'quote-add-quote': RouteRecordInfo<'quote-add-quote', '/quote/addQuote', Record<never, never>, Record<never, never>>,
    'quote-list-qoute': RouteRecordInfo<'quote-list-qoute', '/quote/listQoute', Record<never, never>, Record<never, never>>,
    'realty-project-id': RouteRecordInfo<'realty-project-id', '/realty/project/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'realty-project-list-projects': RouteRecordInfo<'realty-project-list-projects', '/realty/project/list-projects', Record<never, never>, Record<never, never>>,
    'realty-project-register-project': RouteRecordInfo<'realty-project-register-project', '/realty/project/register-project', Record<never, never>, Record<never, never>>,
    'realty-property-id': RouteRecordInfo<'realty-property-id', '/realty/property/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'users-add-user': RouteRecordInfo<'users-add-user', '/users/addUser', Record<never, never>, Record<never, never>>,
    'users-list-users': RouteRecordInfo<'users-list-users', '/users/listUsers', Record<never, never>, Record<never, never>>,
